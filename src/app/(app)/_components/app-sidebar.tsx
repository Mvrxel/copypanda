...
function SidebarLogo() {
  ...
  return (
    <div className="flex gap-2 bg-gray-100 px-2 transition-[padding] duration-200 ease-in-out group-data-[collapsible=icon]:px-0">
              ...
              <SidebarMenu>
                {item.items.map((item) => (
                  <SidebarMenuItem key={item.title}>
                    <SidebarMenuButton
                      asChild
                      className="group/menu-button group-data-[collapsible=icon]:px-[5px]! h-9 gap-3 font-medium [&>svg]:size-auto"
                      tooltip={item.title}
